...
import java.sql.*;
import com.mycompany.proyectofinal.DAO.FacturaDetalladaDAO;

public class FacturaDetalladaDAOImpl implements FacturaDetalladaDAO {

    Connection con;

    public FacturaDetalladaDAOImpl() {
        obtener_conexion();
    }
    ...
    // Funciona
    public void agregar_detalle_factura(FacturaDetallada p_detalle_factura){
